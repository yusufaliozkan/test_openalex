                ...
                if not results_df.empty and 'doi' in results_df.columns:
                    ...
                    def results(merged_df, oa_summary, oa_status_summary):                        
                        ...
                        with col2:                            
                            ...
                            filtered_df.index +=1
                            filtered_df = filtered_df[['doi', 'type_crossref','primary_location.source.display_name', 'primary_location.source.host_organization_name', 'publication_year', 'publication_date', 'open_access.is_oa','open_access.oa_status', 'open_access.oa_url', 'primary_location.license_id']]
