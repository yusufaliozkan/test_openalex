                    ...
                    def results(merged_df, oa_summary, oa_status_summary, duplicates_df):
                        ...
                        with st.expander('Results',  expanded= True):
                            ...
                            if display_unpaywall_option:
                                ...
                                oa_status_summary = oa_status_summary = df_unpaywall['OA Status (Unpaywall)'].value_counts(dropna=False).reset_index()['OA Status (Unpaywall)'].value_counts(dropna=False).reset_index()
                                oa_status_summary
